...
public:
    ...
    void setupUi(QWidget *OverviewPage)
    {
        ...
        labelBalance->setText(QStringLiteral("0 DIC"));
        ...
        labelStake->setText(QStringLiteral("0 DIC"));
        ...
        labelUnconfirmed->setText(QStringLiteral("0 DIC"));
        ...
        labelImmature->setText(QStringLiteral("0 DIC"));
