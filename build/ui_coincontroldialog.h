...
public:
    ...
    void setupUi(QDialog *CoinControlDialog)
    {
        ...
        CoinControlDialog->setStyleSheet(QStringLiteral("background-image: url(:/images/bkg2);"));
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 DIC"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 DIC"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 DIC"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 DIC"));
